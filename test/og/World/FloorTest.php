...
class FloorTest extends BaseTestCase
{
    ...
    {
        $floorHeight = 20;
        $game = $this->createTestGame(Action::moveDistancePerTick() / 2);
        $p = $game->getPlayer(1);
        ...
        for ($i = 1; $i <= Action::moveDistancePerTick() * 2; $i++) {
        ...
        $this->assertGreaterThan(Action::moveDistancePerTick(), $p->getPositionImmutable()->z);
    }
    ...
    public function testPlayerBoxTunnel(): void
    {
        ...
        $game->start();
        $this->assertSame($floorHeight, $p->getPositionImmutable()->y);
        $this->assertSame(20 * Action::moveDistancePerTick(), $p->getPositionImmutable()->z);
    }
