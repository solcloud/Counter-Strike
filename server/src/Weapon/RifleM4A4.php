...
final class RifleM4A4 extends AmmoBasedWeapon
{
    ...
    public const int reloadTimeMs = 3100;
    ...
    public const int fireRateMs = 90;
    public const int damage = 170;
    public const int armorPenetration = 67;
    public const int recoilResetMs = 310;
    public const array recoilPattern = [
        [0.0, 0.0], // fixme better pattern
        [+0.09, +0.17],
        [-0.02, +0.72],
        [+0.04, +1.53],
        [+0.07, +2.32],
